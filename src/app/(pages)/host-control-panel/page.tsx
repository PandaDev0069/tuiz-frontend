...
function HostControlPanelContent() {
  ...
  const fetchPlayers = useCallback(async () => {
    ...
    try {
      ...
      // Players data is available but we use leaderboard instead
    } catch (err) {
  ...
  }, [gameId, currentQuestion, currentQuestionIndex, startQuestion, emitPhaseChange]);
